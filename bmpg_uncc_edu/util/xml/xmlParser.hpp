...
#ifndef bmpg_uncc_edu_util_xml_xmlParser_hpp
#define bmpg_uncc_edu_util_xml_xmlParser_hpp
#include <stdlib.h>
#include <string>
#include <cstring>
...
typedef struct XMLDLLENTRY XMLNode
{
  ...
  public:
    ...
    XMLNode getChildNode(const string& name, int i) const{return getChildNode(name.c_str(),i);}
    XMLNode getChildNode(const string& name, int *i=NULL) const;         ///< return next child node with specific name (return an empty node if failing)
    ...
    int nChildNode(const string& name) const {return nChildNode(name.c_str());}
    ...
    XMLCSTR getAttribute(const string& name, int *i=NULL) const{return getAttribute(name.c_str(),i);}
...
}	//namespace bmpg_uncc_edu::util::xml
}	//namespace bmpg_uncc_edu::util
}	//namespace bmpg_uncc_edu

#endif	//bmpg_uncc_edu_util_xml_xmlParser_hpp
