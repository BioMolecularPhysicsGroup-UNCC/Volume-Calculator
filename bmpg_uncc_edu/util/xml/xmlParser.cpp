...
#ifndef bmpg_uncc_edu_util_xml_xmlParser_cpp
#define bmpg_uncc_edu_util_xml_xmlParser_cpp
#include <memory>
#include <cassert>
#include <cstdio>
#include <string>
...
XMLNode XMLNode::getChildNode(const string& name, int *i) const
{
	return getChildNode(name.c_str(),i);
}
...
#endif	//bmpg_uncc_edu_util_xml_xmlParser_cpp
